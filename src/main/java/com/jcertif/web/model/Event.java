...
public class Event implements Serializable{
	...
	public Event(Long id, Calendar dateDebut, Calendar dateFin,
			String description, String motCle, String nom, String salle,
			String sommaire, Long speakersId, String sujets) {
		super();
		this.id = id;
	...
	public int hashCode() {
		...
		result = prime * result
		+ ((sommaire == null) ? 0 : sommaire.hashCode());
		result = prime * result
		+ ((speakersId == null) ? 0 : speakersId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (id == null) {
			...
			return false;
		if (motCle == null) {
			if (other.motCle != null)
				return false;
		} else if (!motCle.equals(other.motCle))
			return false;
		if (nom == null) {
			if (other.nom != null)
				return false;
		...
		if (salle == null) {
			...
			return false;
		if (sommaire == null) {
			if (other.sommaire != null)
				return false;
		} else if (!sommaire.equals(other.sommaire))
			return false;
		if (speakersId == null) {
			if (other.speakersId != null)
				return false;
		} else if (!speakersId.equals(other.speakersId))
			return false;
		if (sujets == null) {
			if (other.sujets != null)
				return false;
		} else if (!sujets.equals(other.sujets))
			return false;
		return true;
	}
